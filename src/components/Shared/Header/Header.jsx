...
const Header = () => {
  ...
  return (
    <Navbar className="md:w-[90%] md:mx-auto py-4" fluid={true} rounded={true}>
      ...
      <Navbar.Collapse>
        <NavLink
          className={location.pathname === "/" ? "text-amber-800 font-bold" : ""}
          to="/"
        >
          Home
        </NavLink>
        <NavLink
          className={
            location.pathname === "/blogs" ? "text-amber-800 font-bold" : ""
          }
          to="/blogs"
        >
          Blog
