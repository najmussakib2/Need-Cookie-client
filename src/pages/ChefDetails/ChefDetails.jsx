...
const ChefDetails = () => {
  ...
  useEffect(() => {
    fetch(
      `https://chef-recipe-hunter-server-site-nnsnajmussakib-gmailcom.vercel.app/chef-details/${id}`
    )
  ...
  useEffect(() => {
    fetch(
      `https://chef-recipe-hunter-server-site-nnsnajmussakib-gmailcom.vercel.app/chef-recipe/${id}`
    )
      .then((response) => response.json())
        ...
        <div className="max-w-2xl">
          <Card>
            <div className="flex flex-col items-center">
              ...
              />
              <h5 className="mb-1 text-xl font-medium text-amber-600 dark:text-white">
                {chefDetails.name}
              </h5>
